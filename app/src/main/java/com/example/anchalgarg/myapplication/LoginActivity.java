...
public class LoginActivity extends AppCompatActivity {
    private EditText mLoginEmailFeild;
    private EditText mLoginPasswordFeild;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLoginPasswordFeild=(EditText) findViewById(R.id.loginPasswordFeild);
        mLoginEmailFeild=(EditText) findViewById(R.id.loginEmailFeild);
        mLoginBtn=(Button)findViewById(R.id.loginBtn);
        mProgressDial=new ProgressDialog(this);
...
/*
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            mProgressDial.setMessage("Signing In...");
            mProgressDial.show();
            if (result.isSuccess()) {
    ...
    private void checkLogin() {
        String email=mLoginEmailFeild.getText().toString().trim();
        String password=mLoginPasswordFeild.getText().toString().trim();
        if(!TextUtils.isEmpty(email)&&!TextUtils.isEmpty(password))
        {
            mProgressDial.setMessage("CHECKING...");
            mProgressDial.show();
            ...
            mDatabaseUsers.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    if (dataSnapshot.hasChild(UserId)) {
                        domain=dataSnapshot.child(UserId).child("Domain").getValue().toString();
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                               //domain=new String[(int) dataSnapshot.getChildrenCount()];
                                ...
                                for (DataSnapshot domainSnapshot: dataSnapshot.getChildren()) {
                                   if(i==Integer.parseInt(domain)) {
                                      domain_send= domainSnapshot.getKey().toString();
                                       Log.d("GS",""+domain_send);
                                       Intent mainIntent = new Intent(LoginActivity.this,MainActivity.class);
                                       mainIntent.putExtra("senddata",domain_send);
                                       mainIntent.putExtra("tag",UserId);
